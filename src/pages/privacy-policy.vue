<template>
  <div :class="['container', $style.container]">
    <SharedPrivacyPolicyHeader />

    <SharedPrivacyPolicyTableContents />

    <div :class="$style.sections">
      <SharedPrivacyPolicySection title="1. OUR SERVICES">
        <SharedPrivacyPolicyBodyText>
      ...
      </SharedPrivacyPolicySection>

      <SharedPrivacyPolicySection title="2. INTELLECTUAL PROPERTY RIGHTS">
        <SharedPrivacyPolicyHeading level="2">
          Our intellectual property
        </SharedPrivacyPolicyHeading>
        <SharedPrivacyPolicyBodyText>
        ...
        <SharedPrivacyPolicyBodyText>
          ...
          <SharedPrivacyPolicyLink href="#prohibited">
            PROHIBITED ACTIVITIES
          </SharedPrivacyPolicyLink>
          " section below, we grant you a non-exclusive, non-transferable,
          revocable license to: access the Services; and <br />
        ...
        <SharedPrivacyPolicyBodyText>
          ...
          please address your request to: andrew@clarityatl.com . If we ever
        ...
        <SharedPrivacyPolicyBodyText>
          ...
          <br />confirm that you have read and agree with our "
          <SharedPrivacyPolicyLink href="#prohibited">
            PROHIBITED ACTIVITIES
          </SharedPrivacyPolicyLink>
          ...
          or misleading; <br />to the extent permissible by applicable law,
          waive any and all moral rights to any such Submission ; <br />warrant
          ...
          to your Submissions ; and <br />warrant and represent that your
          Submissions do not constitute confidential information. <br />You are
      ...
      <SharedPrivacyPolicySection title="3. USER REPRESENTATIONS">
        <SharedPrivacyPolicyBodyText>
          ...
          are not a minor in the jurisdiction in which you reside ; ( 3) you
      ...
      <SharedPrivacyPolicySection title="4. PURCHASES AND PAYMENT">
        <SharedPrivacyPolicyBodyText>
      ...
      <SharedPrivacyPolicySection title="5. POLICY">
        <SharedPrivacyPolicyBodyText>
      ...
      <SharedPrivacyPolicySection title="6. PROHIBITED ACTIVITIES">
        <SharedPrivacyPolicyBodyText>
        ...
        <SharedPrivacyPolicyBodyText>
          ...
          <br />Systematically retrieve data or other content from the Services
          to create or compile, directly or indirectly, a collection,
          compilation, database, or directory without written permission from
          us. <br />Trick, defraud, or mislead us and other users, especially in
          ...
          therein. <br />Disparage, tarnish, or otherwise harm, in our opinion,
          us and/or the Services. <br />Use any information obtained from the
          Services in order to harass, abuse, or harm another person. <br />Make
          improper use of our support services or submit false reports of abuse
          or misconduct. <br />Use the Services in a manner inconsistent with
          any applicable laws or regulations. <br />Engage in unauthorized
          framing of or linking to the Services. <br />Upload or transmit (or
          ...
          functions, operation, or maintenance of the Services. <br />Engage in
          ...
          data gathering and extraction tools. <br />Delete the copyright or
          other proprietary rights notice from any Content. <br />Attempt to
          impersonate another user or person or use the username of another
          user. <br />Upload or transmit (or attempt to upload or to transmit)
          ...
          services connected to the Services. <br />Harass, annoy, intimidate,
          or threaten any of our employees or agents engaged in providing any
          portion of the Services to you. <br />Attempt to bypass any measures
          of the Services designed to prevent or restrict access to the
          Services, or any portion of the Services. <br />Copy or adapt the
          Services' software, including but not limited to Flash, PHP, HTML,
          JavaScript, or other code. <br />Except as permitted by applicable
          ...
          or use or launch any unauthorized script or other software. <br />Use
          a buying agent or purchasing agent to make purchases on the Services.
          <br />Make any unauthorized use of the Services, including collecting
          ...
          accounts by automated means or under false pretenses . <br />Use the
          ...
          commercial enterprise. <br />Sell or otherwise transfer your profile.
        </SharedPrivacyPolicyBodyText>
      </SharedPrivacyPolicySection>

      <SharedPrivacyPolicySection title="7. USER GENERATED CONTRIBUTIONS">
        <SharedPrivacyPolicyBodyText>
          ...
          secret, or moral rights of any third party. <br />You are the creator
          ...
          manner contemplated by the Services and these Legal Terms. <br />You
          ...
          contemplated by the Services and these Legal Terms. <br />Your
          ...
          mailings, or other forms of solicitation. <br />Your Contributions are
          not obscene, lewd, lascivious, filthy, violent, harassing, libelous,
          slanderous, or otherwise objectionable (as determined by us).
          <br />Your Contributions do not ridicule, mock, disparage, intimidate,
          or abuse anyone. <br />Your Contributions are not used to harass or
          ...
          regulation, or rule. <br />Your Contributions do not violate the
          privacy or publicity rights of any third party. <br />Your
          ...
          of minors. <br />Your Contributions do not include any offensive
          comments that are connected to race, national origin, gender, sexual
          preference, or physical handicap. <br />Your Contributions do not
          otherwise violate, or link to material that violates, any provision of
          these Legal Terms, or any applicable law or regulation. <br />Any use
      ...
      <SharedPrivacyPolicySection title="8. CONTRIBUTION LICENSE">
        <SharedPrivacyPolicyBodyText>
      ...
      <SharedPrivacyPolicySection title="9. THIRD-PARTY WEBSITES AND CONTENT">
        <SharedPrivacyPolicyBodyText>
      ...
      <SharedPrivacyPolicySection title="10. SERVICES MANAGEMENT">
        <SharedPrivacyPolicyBodyText>
      ...
      <SharedPrivacyPolicySection title="11. PRIVACY POLICY">
        <SharedPrivacyPolicyBodyText>
      ...
      <SharedPrivacyPolicySection title="12. TERM AND TERMINATION">
        <SharedPrivacyPolicyBodyText>
      ...
      <SharedPrivacyPolicySection title="13. MODIFICATIONS AND INTERRUPTIONS">
        <SharedPrivacyPolicyBodyText>
      ...
      <SharedPrivacyPolicySection title="14. GOVERNING LAW">
        <SharedPrivacyPolicyBodyText>
      ...
      <SharedPrivacyPolicySection title="15. DISPUTE RESOLUTION">
        <SharedPrivacyPolicyHeading level="2">
        ...
        <SharedPrivacyPolicyBodyText>
          ...
          >
            ...
            website</SharedPrivacyPolicyLink
          ...
          rules or applicable law, the arbitration will take place in Fulton ,
        ...
        <SharedPrivacyPolicyBodyText>
          ...
          and federal courts located inFulton,Georgia , and the Parties hereby
      ...
      <SharedPrivacyPolicySection title="16. CORRECTIONS">
        <SharedPrivacyPolicyBodyText>
      ...
      <SharedPrivacyPolicySection title="17. DISCLAIMER">
        <SharedPrivacyPolicyBodyText>
      ...
      <SharedPrivacyPolicySection title="18. LIMITATIONS OF LIABILITY">
        <SharedPrivacyPolicyBodyText>
      ...
      <SharedPrivacyPolicySection title="19. INDEMNIFICATION">
        <SharedPrivacyPolicyBodyText>
      ...
      <SharedPrivacyPolicySection title="20. USER DATA">
        <SharedPrivacyPolicyBodyText>
      ...
      <SharedPrivacyPolicySection title="22. CALIFORNIA USERS AND RESIDENTS">
        <SharedPrivacyPolicyBodyText>
      ...
      <SharedPrivacyPolicySection title="23. MISCELLANEOUS">
        <SharedPrivacyPolicyBodyText>
      ...
      <SharedPrivacyPolicySection title="24. CONTACT US">
        <SharedPrivacyPolicyBodyText>
        ...
        <SharedPrivacyPolicyBodyText>
          <strong>Clarity Water LLC</strong>
          <br />
          <strong>1081 Lee Cir NE</strong>
          <br />
          <strong>Atlanta , GA30324</strong>
          <br />
          <strong>Georgia</strong>
          <br />
          <strong>Phone: 6789832560</strong>
          <br />
          <strong>andrew@clarityatl.com</strong>
        </SharedPrivacyPolicyBodyText>
        <SharedPrivacyPolicyBodyText>
          ...
          <SharedPrivacyPolicyLink
            ...
            rel="noopener noreferrer"
            target="_blank"
            >Terms and Conditions Generator </SharedPrivacyPolicyLink
          >.
        </SharedPrivacyPolicyBodyText>
      </SharedPrivacyPolicySection>
    </div>
